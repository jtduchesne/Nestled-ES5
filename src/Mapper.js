...
(function(Nestled, undefined) {
    ...
    Mapper.prototype = {
        ...
        getName: function(mapperNumber) {
            return this.nameLookup[mapperNumber]; },
        getFormattedName: function(mapperNumber) {
            return "Mapper #" + mapperNumber + " : " + this.nameLookup[mapperNumber]; },
